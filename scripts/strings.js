...
var strings = (function(){
	...
	my.contains = function(string, substring){
	...
	my.replaceAccentBearingLettersWithASCISubstitute = function(string){
		...
		//A
		text = text.replace(/á/g,"a").replace(/à/g,"a").replace(/Á/g,"A").replace(/À/g,"A").replace(/ä/g,"ae").replace(/Ä/g,"Ae").replace(/å/g,"a").replace(/Å/g,"A");
		...
		//U
		text = text.replace(/Ü/g,"Ue").replace(/ü/g,"ue").replace(/Û/g,"U").replace(/û/g,"u");

		//Y
		text = text.replace(/ÿ/g,"y").replace(/Ý/g,"Y");
